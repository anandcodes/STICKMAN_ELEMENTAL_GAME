...
function level3(): LevelDef {
  ...
  const envObjects: EnvObject[] = [
    ...
    // Spikes in gaps
    makeSpike(420, 700, 60), makeSpike(770, 700, 60),
    makeSpike(1170, 700, 60), makeSpike(1470, 700, 60),
    // Gems
...
function level5(): LevelDef {
  ...
  const enemies: Enemy[] = [
    ...
    makeEnemy('ice_spirit', 2700, 380, 'fire', 'water', 120, 14, 1.5, 60),
    makeEnemy('golem', 3100, 580, 'water', 'earth', 100, 22, 0.8, 150),
  ];
