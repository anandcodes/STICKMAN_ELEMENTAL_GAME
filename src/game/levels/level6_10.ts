...
export function level6(): LevelDef {
    ...
    return {
        ...
        bgColors: ['#ffee99', '#ffcc55', '#bbff77', '#88eeaa'],
        platforms, envObjects, enemies, hazards: [],
...
export function level7(): LevelDef {
    ...
    return {
        ...
        bgColors: ['#66aaff', '#99ccff', '#ccf5ff', '#ffffff'],
        platforms, envObjects, enemies, hazards: [],
        playerStart: { x: 60, y: 480 },
        gemsRequired: 8, totalGems: 10,
...
export function level8(): LevelDef {
    ...
    return {
        ...
        bgColors: ['#ff77cc', '#ff99ff', '#ffbbee', '#ff77aa'], // Vivid pink/purple crystal
        platforms, envObjects, enemies, hazards: [],
        playerStart: { x: 60, y: 480 },
        gemsRequired: 8, totalGems: 10,
...
export function level9(): LevelDef {
    ...
    return {
        ...
        bgColors: ['#44eeff', '#77ffff', '#aaffff', '#44aaff'],
        platforms, envObjects, enemies, hazards: [],
        playerStart: { x: 60, y: 480 },
...
export function level10(): LevelDef {
    ...
    return {
        ...
        bgColors: ['#ff4488', '#ff77aa', '#ffaa55', '#ffcc44'],
        platforms, envObjects, enemies, hazards: [],
        playerStart: { x: 60, y: 480 },
